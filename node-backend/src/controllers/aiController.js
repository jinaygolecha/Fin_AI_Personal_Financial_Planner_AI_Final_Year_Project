  ...
  try {
    ...
    return res.status(200).json({
      ...
      data: {
        ...
        incomeThisMonth: ctx.incomeThisMonth,
        formattedIncome: formatINR(ctx.incomeThisMonth),
        expensesThisMonth: ctx.expensesThisMonth,
        formattedExpenses: formatINR(ctx.expensesThisMonth),
